...
cols_extract<-c(1,2,sort(append(cols_mean,cols_std)))
...
#step 4 - appropriately label each variabkle with a descriptive name
...
avg_tidy<-matrix(0, nrow=180,ncol=66)
...
names_tidy<-c("Subject", "Activity",paste("Avg",names_extract[3:68], sep=""))
